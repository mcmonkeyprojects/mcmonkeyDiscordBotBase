...
namespace DiscordBotBase
{
    ...
    {
        /// <summary>
        /// How many messages to store per text channel.
        /// </summary>
        public int MessagesPerChannel;

        /// <summary>
        /// The backing Discord bot.
        /// </summary>
        ...
        /// <summary>
        /// Represents a single cached message.
        /// </summary>
        public struct CachedMessage
        {
            ...
            /// <summary>
            /// Attachment URLs, newline separated, if any.
            /// </summary>
            public string Attachments;
        }

        /// <summary>
        /// The caching data for a single channel.
        /// </summary>
        public class SingleChannelCache
        {
            /// <summary>
            /// Constructs the channel cache instance with a specified cache size.
            /// </summary>
            ...
            /// <summary>
            /// All cached message IDs, in order sent, for cache clearing.
            /// </summary>
            public Queue<ulong> IDsInSentOrder;

            /// <summary>
            /// A map of message IDs to cached data.
            /// </summary>
            ...
            /// <summary>
            /// Adds a new message into this channel cache.
            /// </summary>
        ...
        /// <summary>
        /// Prefill the cache with previously sent messages.
        /// </summary>
        public void Prefill()
        {
            ...
            foreach (SocketGuild guild in Bot.Client.Guilds)
            {
                foreach (SocketTextChannel channel in guild.TextChannels)
                {
                    ...
                    try
                    {
                        ...
                        channel.GetMessagesAsync(MessagesPerChannel).ForEachAwaitAsync(async col =>
                        {
